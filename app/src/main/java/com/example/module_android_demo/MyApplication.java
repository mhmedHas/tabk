...
public class MyApplication extends Application {
    ...
    public boolean gpodemox=false;
    public int[] gpoxs;

	public SPconfig spf;
	public RfidPower Rpower;
	public boolean Ismulpro= false;
	...
	public boolean ishadvstatic=false;//本次已统计
    ...
    public boolean  filterreadbank=false;
    ...
    public int readcfilterv=5;
    public  boolean isreadc=false;

    public boolean iscycsucesper=false;
    public int cycsucescount=0;
    public int allcyc=0;
    public int sucesscyc=0;
	...
	public class ReaderParams {
		...
		public int iso6bblf;
		public int option;
        public int exfastmodeoption;
		// other params

		public String password;
		public int optime;
        public  boolean isstopfornonewtag;
